...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210625_ef6edfa73eae89cb5554_20210625141302_archive.zip';
	const ARCHIVE_SIZE		 = '35384030';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ef6edfa-25141302';
    const SECONDARY_PACKAGE_HASH = 'ed78bd0-25141302';
	const VERSION			 = '1.4.1';
